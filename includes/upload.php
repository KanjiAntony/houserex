...
class photo_uploads{
    ...
    private $logged_upload_dir="../Uploaded";
...
/* function __construct() {
    ...
    if($_FILES){
        ...
        if($image){
             ...
             /* echo "<img src='$target_dir' width='150px' height='150px'> <br/>"; */
              ...
              {
                   $this->path_cover_name($target_dir2);
 ...
 /*function validate_profile_image(){
    ...
    if($_FILES){
        $name=$this->photo_name;
        $target_dir="..".DS.$this->upload_dir.DS.'Images'.DS.$this->move_to;
        $target_dir2=$this->upload_dir.DS.'Images'.DS.$this->move_to;
        $temp_loc=$this->tmp_loc;
