		...
		<div class="tab-content" id="myTabContent">
			...
			<div class="tab-pane fade" id="map_tabs" role="tabpanel" aria-labelledby="map-tab">
			    <div id="floating-panel">
                  <input id="address" type="textbox" value="<?php echo $database->fetched_Paddress; ?>, <?php echo $database->fetched_Pcity; ?>, <?php echo $database->fetched_Pcounty; ?>" />
			...
			<div class="row">
				<div class="col-lg-7 col-xl-8">
					<div class="single_property_title mt30-767 mb30-767">
						...
						<p><?php echo $database->fetched_Paddress; ?>, <?php echo $database->fetched_Pcity; ?></p>
					</div>
				</div>
				<div class="col-lg-5 col-xl-4">
					<div class="single_property_social_share">
						<div class="price float-left fn-400">
							<h2>£ <?php echo $database->fetched_Pprice; ?></h2>
						</div>
				...
				<div class="col-md-12 col-lg-8 mt50">
					<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-6 col-lg-6 col-xl-4">
										...
										<ul class="list-inline-item">
											...
											<li><p><span>£ <?php echo $database->fetched_Pprice; ?></span></p></li>
									...
									<div class="col-md-6 col-lg-6 col-xl-4">
										...
										<ul class="list-inline-item">
											<li><p><span><?php echo $database->fetched_Prooms; ?></span></p></li>
											<li><p><span><?php echo $database->fetched_Pbedrooms; ?></span></p></li>
											<li><p><span><?php echo $database->fetched_Pbathrooms; ?></span></p></li>
						...
						<div class="col-lg-12">
							<div class="application_statics mt30">
								<h4 class="mb30">Location (google maps coming soon) <small class="float-right"><?php echo $database->fetched_Paddress; ?>, <?php echo $database->fetched_Pcity; ?>, <?php echo $database->fetched_Pcounty; ?></small></h4>
								<h4 class="mb30">Latitude: <?php echo $database->fetched_Platitude; ?></h4>
								<h4 class="mb30">Longitude: <?php echo $database->fetched_Plongitude; ?></h4>
								...
								<div class="tab-content" id="myTabContent2">
									<div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
										<div class="property_video">
											<div class="thumb">
											    <video src="Uploaded/Videos/Love is fire.mp4" width="100%" controls>
						...
						<?php
					        ...
					        $sql = $database->get_all_user_listings($database->fetched_ownerId);
