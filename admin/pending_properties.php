					...
					<div class="row">
						...
						<div class="col-lg-4 col-xl-4 mb10">
							<div class="breadcrumb_content style2 mb10">
								<h2 class="breadcrumb_title">Pending properties</h2>
...
<script>
  ...
  $(document).ready(function(){
    ...
    function fetchAllProperties() {
        ...
        document.getElementById("dummy_loading").innerHTML = "Showing all pending listings, please wait";
		...
		var picExtensionUrl = "assets/php/fetch_unapproved_listings.php";
	...
	//	picRequest.upload.addEventListener("progress", progressHandler, false);
		...
		picRequest.addEventListener("error", function(ev) {
		    _("dummy_status").innerHTML = "Showing all unapproved listings failed";
        ...
        picRequest.addEventListener("abort", function(ev) {
             _("dummy_status").innerHTML = "Showing all unapproved listings aborted";
