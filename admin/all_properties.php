...
<script>
  ...
  $(document).ready(function(){
    ...
    function fetchAllProperties() {
        ...
        document.getElementById("dummy_loading").innerHTML = "Showing all listings, please wait";
		...
		var picExtensionUrl = "assets/php/fetch_all_listings.php";
	...
	//	picRequest.upload.addEventListener("progress", progressHandler, false);
		...
		picRequest.addEventListener("error", function(ev) {
		    _("dummy_status").innerHTML = "Showing all listings failed";
        ...
        picRequest.addEventListener("abort", function(ev) {
             _("dummy_status").innerHTML = "Showing all listings aborted";
