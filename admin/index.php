					...
					<div class="row">
						...
						<div class="col-lg-4 col-xl-4 mb10">
							<div class="breadcrumb_content style2 mb10">
								<h2 class="breadcrumb_title">Users pending approval</h2>
...
<script>
  ...
  $(document).ready(function(){
    ...
    function fetchAllUsers() {
        ...
        document.getElementById("dummy_loading").innerHTML = "Showing all users pending approval, please wait";
		...
		var picExtensionUrl = "assets/php/fetch_unapproved_users.php";
	...
	//	picRequest.upload.addEventListener("progress", progressHandler, false);
		...
		picRequest.addEventListener("error", function(ev) {
		    _("dummy_status").innerHTML = "Showing all users failed";
        ...
        picRequest.addEventListener("abort", function(ev) {
             _("dummy_status").innerHTML = "Showing all users aborted";
