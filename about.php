...
$database->get_pages_data_details("ABOUT");
			...
			<div class="row">
				...
				<div class="col-lg-4 col-xl-4">
					<div class="terms_condition_widget">
						<h3 class="title">Give review</h3>
						<div class="widget_list">
							<a href="https://www.trustpilot.com/review/houserex.co.uk" target="_blank"><img src="images/trustpilot.png" width="100%" height="100%"></a>
						</div>
					</div>
				</div>
			</div>
