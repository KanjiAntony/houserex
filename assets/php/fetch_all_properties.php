...
require_once("../../includes/initialise.php");
        ...
        foreach($sql as $row) {
            ...
            if($row['Pcategory'] == "Rent") {
					...
					<a href="rent_property_view.php?id='.$row['PID'].'">
					...
					<img class="img" src="assets/php/Uploaded/Images/'.json_decode($row['Pimage'])[0].'" alt="" width="100%" height="200px">
						...
						<div class="feat_property" style="border-radius:0px;z-index:1">
							<a href="rent_property_view.php?id='.$row['PID'].'"><div class="thumb">
							
								
								
								<div class="thmb_cntnt"><a href="rent_property_view.php?id='.$row['PID'].'">
									<ul class="tag mb0">
							...
							<div class="details" style="border-radius:0px;">
								<div class="tc_content">

								<ul class="tag mb0">
										<li class="list-inline-item"><a href="rent_properties.php" class="btn btn-block btn-thm">For rent</a></li>

										<ul class="icon mb0">
        											<li class="list-inline-item"><h3>£ '.$row['Pprice'].'<small> / '.$row['PpricePeriod'].'</small></h3></li>
        								</ul>
									</ul>
