...
<script>
  ...
  $(document).ready(function(){
    ...
    function fetchMyProperties() {
        ...
        document.getElementById("dummy_loading").innerHTML = "Listing my properties, please wait";
        ...
        var picQueryString = "action=" + action + "&user_id=" + user_id;
		var picExtensionUrl = "assets/php/fetch_user_properties.php";
	...
	//	picRequest.upload.addEventListener("progress", progressHandler, false);
		...
		picRequest.addEventListener("error", function(ev) {
		    _("dummy_status").innerHTML = "Listing my properties failed";
        ...
        picRequest.addEventListener("abort", function(ev) {
             _("dummy_status").innerHTML = "Listing my properties aborted";
